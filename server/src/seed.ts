...
const SEED_ENTRIES = [
  { week_year: 2026, week_month: 6, week_number: 2, priority: '중요', department: '개발팀', title: '[홍길동] 업무보고_2026.06.08~06.12', completed_work: '업무보고 시스템 개발 완료\n등록페이지 화면 설계 정리', ongoing_work: 'ERP 연동 설계 진행중\n메인 화면 플로우 정리 중', next_week_plan: '모바일 앱 검토 예정\n차주 메인 화면 상세 플로우 정리', notes: '스윗 연동 방식 추후 확정 필요' },
  ...
  { week_year: 2026, week_month: 5, week_number: 4, priority: '긴급', department: '개발팀', title: '[홍길동] 업무보고_2026.05.25~05.29', completed_work: '배포 전 체크리스트 정리\n테스트 계정 권한 확인', ongoing_work: '운영 반영 일정 협의', next_week_plan: '잔여 UI QA 진행', notes: '긴급 항목 스윗 전송 완료 상태로 확인' },
  ...
  { week_year: 2026, week_month: 5, week_number: 2, priority: '중요', department: '개발팀', title: '[홍길동] 업무보고_2026.05.11~05.15', completed_work: 'API 명세 작성 완료\n로그인 기능 구현', ongoing_work: '토큰 갱신 로직 검토', next_week_plan: '권한별 라우팅 구현', notes: '' },
